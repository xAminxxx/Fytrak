...
const styles = StyleSheet.create({
  ...
  cardWrapper: { flex: 1 },
  card: { height: 260, backgroundColor: '#161616', borderRadius: 24, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: '#333', gap: 20 },
  cardSelected: { borderColor: colors.primary, backgroundColor: '#1a1a10', borderWidth: 1.5 },
